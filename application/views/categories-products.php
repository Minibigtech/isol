...
<head>
    ...
    <title><?php echo $data->cl1_title;?> - <?php echo site_title;?></title>
            ...
            <div class="row">
                <div class="col-md-12 no-padding">
                    <div class="btn-group btn-breadcrumb breadcrumb-primary">
                        ...
                        <a href="javascript:;" class="btn btn-primary visible-lg-block visible-md-block"><?php echo $data->cl1_title;?></a>
            ...
            <div class="row">
                <div class="col-md-3">
                    <ul id="accordion" class="accordion">
                        <?php 
                        $this->db->select('*')->from('category_level2')->where(array('cl1_id'=>$data->cl1_id,'cl2_status'=>1));
                        $sql = $this->db->get();
                        if( $sql->num_rows()>0 ):
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="<?php echo $row?>"><?php echo $val1->cl3_title;?></a></li>
                                <?php endforeach;?>
                            </ul>
                            <?php else:?>
                            <ul class="submenu">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12 no-padding">
                        ...
                        <?php foreach( $products as $records ):?>
                        <div class="col-md-4">
                            <div class="prd">
                                <a href="<?php echo base_url('preview/'.$records->product_slug.'/'.$records->product_reference);?>">
                                <?php echo $records->product_photo!=''?'<img src="'.base_url().'assets/images/products/'.$records->product_photo.'" class="img-responsive" alt="">':'<img src="'.base_url().'assets/images/no-image.png" class="img-responsive" alt="">';?>
                                </a>
                                <h4><?php echo $records->product_title;?></h4>
                                <p>Rs. <?php echo $records->product_price;?></p>
                            </div>
                        </div>
                        <?php endforeach;?>
                        <?php endif;?>
