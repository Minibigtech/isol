            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php endif; ?>
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Home Banners</h3>
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $value->photo!=''?'<img src="'.base_url('assets/images/banners/').$value->photo.'" style="width:200px; hight:40px">':'<img src="'.base_url('assets/images/no-image.png').'" style="width:200px; hight:40px">';?></td>
                                            <td><?php echo $value->link;?></td>
                                            <td><?php echo $value->status==1?'Active':'Deactive';?></td>
                                            <td>
                                                <a href="<?php echo base_url();?>admin/edit-home-banner/<?php echo $value->id;?>"><i class="fa fa-pencil" title="Edit"></i></a><!--  | 
