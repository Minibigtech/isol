            ...
            <div class="container-fluid">
                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <h4 class="page-title">Data Entry Operator</h4>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form action="<?php echo base_url();?>admin/insert-operator" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="admin_firstname"  value="" required>
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="admin_lastname"  value="" required>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="admin_login"  value="" required>
