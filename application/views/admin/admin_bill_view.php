            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php endif; ?>
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Billing Details</h3>
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php  echo $bill_data[0]->first_name;?></td>          
                                            <td><?php  echo $bill_data[0]->last_name;?></td>
                                            <td><?php  echo $bill_data[0]->email;?></td>
                                            <td><?php  echo $bill_data[0]->shipping_address;?></td>
                                            <td><?php  echo $bill_data[0]->billing_address;?></td>
                                            <td><?php  echo $bill_data[0]->contact_number;?></td>
                                            <td><?php  echo $bill_data[0]->additional_information;?></td>
                                            <td><?php  echo $bill_data[0]->billing_date;?></td>
                                            


                                           <!--
                                            <td>
                                                <a href="<?php echo base_url();?>admin/edit-admin-bill-view/<?php echo $bill_data[0]->bill_id;?>"><i class="fa fa-pencil" title="Edit"></i></a>
                                            </td>
                                           --> 
                                        </tr>
