                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo  base_url() ?>admin/admin-view-billing-details/<?php echo $order->order_id;?>"  class="btn btn-primary">Billing Details</a>
                                                
                                            </td>    
                                            <td>
                                                <a href="<?php echo  base_url() ?>admin/admin-view-order-details/<?php echo $order->order_id;?>"  class="btn btn-primary">Order Details</a>

                                            <?php  //echo $order->order_id;

                                            ?></td>
                                            <td><?php  echo $order->order_date;?>  </td>  
                                            <td>   <?php  //echo $order->order_status==1?'Active':'Deactive';?>
                                                
                                              <select  name = "order_status" id="<?php echo  $order->order_id;  ?>">
                                                    ...
                                                    <option value="2"  <?php echo  ($order->order_status==2)?'selected':''?>>Rejected</option>
                                            ...
                                            <!--
                                            <td>
                                                <a href="<?php echo base_url();?>admin/edit-admin-orders/<?php echo $order->order_id;?>"><i class="fa fa-pencil" title="Edit"></i></a><!--  | 
