    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Product Variations</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <?php if( $this->session->flashdata('pv') ):?>
                        <div class="alert alert-success alert-dismissable">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
                            <?php echo $this->session->flashdata('pv');?>
                        </div>
                        <?php endif; ?>
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Product Variations</h3>
                            <div class="table-responsive">
                                <table width="100%">
                                    <tr>
                                        <td colspan="5" align="right">
                                            <a href="<?php echo base_url();?>admin/add-product-variation" title="Add New"><i class="fa fa-plus"></i></a></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="5">
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $value->pav_title;?></td>
                                            <td><?php echo $value->pa_title;?></td>
                                            <td><?php echo $value->pav_status==1?'Active':'Deactive';?></td>
                                            <td>
                                                <a href="<?php echo base_url();?>admin/edit-product-variation/<?php echo $value->pav_id;?>"><i class="fa fa-pencil" title="Edit"></i></a><!--  | 
