    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <?php if( $this->session->flashdata('att') ):?>
                        <div class="alert alert-success alert-dismissable">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
                            <?php echo $this->session->flashdata('att');?>
                        </div>
                        <?php endif; ?>
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Product Attributes</h3>
                            <div class="table-responsive">
                                <table width="100%">
                                    <tr>
                                        <td colspan="5" align="right">
                                            <a href="<?php echo base_url();?>admin/add-product-attribute" title="Add New"><i class="fa fa-plus"></i></a></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="5">
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $value->pa_status==1?'Active':'Deactive';?></td>
                                            <td>
                                                <a href="<?php echo base_url();?>admin/edit-product-attribute/<?php echo $value->pa_id;?>"><i class="fa fa-pencil" title="Edit"></i></a><!--  | 
