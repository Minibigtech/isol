                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Edit Product Variation</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-info">
                            <div class="panel-heading">Edit Product Variation</div>
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form action="<?php echo base_url();?>admin/update-product-variation" method="post" enctype="multipart/form-data">
                                        <div class="form-body">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="attribute" required>
                                                            ...
                                                            <?php $this->db->select('*')->from('product_attributes')->where('pa_status',1);?>
                                                            <?php $sql = $this->db->get();?>
                                                            <?php foreach( $sql->result() as $val ):?>
                                                            <option value="<?php echo $val->pa_id;?>" <?php echo $val->pa_id==$variation->pav_attribute_id?'selected':'';?>><?php echo $val->pa_title;?></option>
                                                            <?php endforeach;?>
                                                        </select>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="control-label">Variation Title</label>
                                                        <input type="text" class="form-control" name="title" placeholder="Clothes" value="<?php echo $variation->pav_title;?>" required>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="status" required>
                                                            <option value="">--Select--</option>
                                                            <option value="1" <?php echo $variation->pav_status==1?'selected':'';?> >Active</option>
                                                            <option value="0" <?php echo $variation->pav_status==0?'selected':'';?>>Deactive</option>
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="form-actions">
                                            <input type="hidden" class="form-control" name="id" value="<?php echo $variation->pav_id;?>">
