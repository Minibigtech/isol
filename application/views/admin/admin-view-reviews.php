...
<body class="fix-sidebar">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php endif; ?>
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Reviews</h3>
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <img src="<?php echo base_url(); ?>assets/images/products/<?php echo $value->product_photo ?>" width="180px" />
                                            ...
                                            <td>
                                                ...
                                                <?php endfor;?>
                                            <td>   
                                              <select  name = "review_status" id="<?php echo  $value->review_id;  ?>">

                                                    <option value="1"  <?php echo  ($value->status==1)?'selected':''?>>Confirmed</option>
                                            ...
                                            <td>
                                               <!--
                                                <a href="<?php echo base_url();?>admin/edit-admin-orders/<?php echo $value->review_id;?>"><i class="fa fa-pencil" title="Edit"></i></a> -->
                                               
                                        <a href="javascript:;" id="<?php echo $value->review_id;?>" title="Delete"><i class="fa fa-trash" ></i></a> 
                                            </td>
    ...
    $(document).ready(function(){
        ...
        $('select[name=review_status]').on('change', function() {
                ...
                var object    = $('select[name=review_status]'); 
                var status_id = object.val();
                var review_id  = object.attr('id');

                
                $.ajax({

                    url:'<?php echo base_url() ?>admin/review-status',
                    type:'POST',
                    data:{'review_id':review_id,'status_id':status_id},
        ...
        $(document).on('click','[title = "Delete"]' , function(){
            ...
            if(confirm('Are you sure ')){
                ...
                $.ajax({
                        ...
                        url     :'<?php echo base_url() ?>admin/review-delete',
                        type    :'POST',
