            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Home Right Sidebar Deals</h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="<?php echo base_url();?>admin/dashboard">Dashboard</a></li>
                            <li><a href="<?php echo base_url();?>admin/deals">Home Right Sidebar Deals</a></li>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form action="<?php echo base_url();?>admin/update-deal" method="post" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="title" placeholder="Get best deals on footwear" value="<?php echo $deal->d_title;?>" required>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="control-label">Photo</label>
                                                        <input type="file" class="form-control" name="photo">
                                                        <?php echo $deal->d_photo!=''?'<br><img src="'.base_url('assets/images/deals/').$deal->d_photo.'" style="width:100px; hight:100px">':'<br><img src="'.base_url('assets/images/no-image.png').'" style="width:100px; hight:100px">';?>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="control-label">Deal Link</label>
                                                        <input type="text" class="form-control" name="link" placeholder="https://www.google.com/" value="<?php echo $deal->d_link;?>">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="status" required>
                                                            ...
                                                            <option value="1" <?php echo $deal->d_status==1?'selected':'';?> >Active</option>
                                                            <option value="0" <?php echo $deal->d_status==0?'selected':'';?>>Deactive</option>
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="form-actions">
                                            <input type="hidden" class="form-control" name="id" value="<?php echo $deal->d_id;?>">
