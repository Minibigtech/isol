    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <?php if( $this->session->flashdata('slide') ):?>
                        <div class="alert alert-success alert-dismissable">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
                            <?php echo $this->session->flashdata('slide');?>
                        </div>
                        <?php endif; ?>
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Home Slides</h3>
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $value->slide_photo!=''?'<img src="'.base_url('assets/images/slides/').$value->slide_photo.'" style="width:150px; hight:60px">':'<img src="'.base_url('assets/images/no-image.png').'" style="width:150px; hight:60px">';?></td>
                                            <td><?php echo $value->slide_link;?></td>
                                            <td><?php echo $value->slide_status==1?'Active':'Deactive';?></td>
                                            <td>
                                                <a href="<?php echo base_url();?>admin/edit-home-slide/<?php echo $value->slide_id;?>"><i class="fa fa-pencil" title="Edit"></i></a><!--  | 
