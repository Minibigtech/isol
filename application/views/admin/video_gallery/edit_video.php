            ...
            <div class="row bg-title">
                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url();?>admin/listing">Edit Video</a></li>
            ...
            <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="white-box p-l-20 p-r-20">
                            <h3 class="box-title m-b-0">Edit video</h3>
                            <div class="row">
                                <div class="col-md-12">
                                    <form class="form-material form-horizontal" method="post" action="<?php echo base_url('admin/update_video');?>" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input type="hidden" name="id" value="<?php echo $video->id;?>">
                                                <input type="text" name="title" class="form-control" placeholder="Title" required="" value="<?php echo $video->title?>"><br>
                                                <label>Short Description</label>
                                                <textarea name="short_description" class="form-control"><?php echo $video->short_description?></textarea>
                                                <label class="radio-inline"><input type="radio" name="optradio" checked="" value="youtube" <?php echo ($video->optradio == 'youtube')?'checked':''?>>YouTube</label>
                                                <label class="radio-inline"><input type="radio" name="optradio" value="dailymotion" <?php echo ($video->optradio == 'dailymotion')?'checked':''?> >Dailymotion</label>
                                                <input type="text" name="link" required="" class="form-control" placeholder="link"  value="<?php echo $video->link?>"><br>
                                                <br><br>
                                                <?php   $youtube= substr($video->link,32);?>
                                                <iframe width="200" height="100" src="https://www.youtube.com/embed/<?php echo $youtube;?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                </div>
