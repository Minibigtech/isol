                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo  $product = $this->db->query('select product_title from products where product_id = '.$val->productcode)->row()->product_title;;?></td>
                                            <td><?php echo $val->orderdate;?></td>
                                        </tr>
                                    <?php }?>
                                    </tbody>
