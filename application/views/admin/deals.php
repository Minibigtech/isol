...
<body class="fix-sidebar">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Home Right Sidebar Deals</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <?php if( $this->session->flashdata('deal') ):?>
                        <div class="alert alert-success alert-dismissable">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
                            <?php echo $this->session->flashdata('deal');?>
                        </div>
                        <?php endif; ?>
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Home Right Sidebar Deals</h3>
                            <div class="table-responsive">
                                <table width="100%">
                                    <tr>
                                        <td colspan="5" align="right">
                                            <a href="<?php echo base_url();?>admin/add-deal" title="Add New"><i class="fa fa-plus"></i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="5">
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $value->d_title;?></td>
                                            <td><?php echo $value->d_photo!=''?'<img src="'.base_url('assets/images/deals/').$value->d_photo.'" style="width:100px; hight:100px">':'<img src="'.base_url('assets/images/no-image.png').'" style="width:100px; hight:100px">';?></td>
                                            <td><?php echo $value->d_status==1?'Active':'Deactive';?></td>
                                            <td>
                                                <a href="<?php echo base_url();?>admin/edit-deal/<?php echo $value->d_id;?>"><i class="fa fa-pencil" title="Edit"></i></a><!--  | 
    ...
    $(document).on('click','[title="Delete Category"]',function(){
            ...
            if( $(this).attr('id') != '' && $(this).attr('id') != 0 ){
                $.ajax({
                    ...
                    success:function(data){
                        if( data == 'Error' ){
                            alert('Sorry some users has used this category for their listing');
                            return false;
                        }
                        //alert(data);    
