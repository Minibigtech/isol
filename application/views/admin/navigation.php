            ...
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                ...
                <div class="top-left-part"><a class="logo" href="<?php echo base_url('admin') ?>">
                    ...
                    <b>
                        ...
                        <img src="<?php echo base_url();?>assets/plugins/images/eliteadmin-logo.png" alt="home" class="dark-logo" />

                        <img src="<?php echo base_url();?>assets/frontend/img/logo.png" alt="home" class="light-logo" />
                        ...
                        <ul class="dropdown-menu mega-dropdown-menu animated bounceInDown">
                            ...
                            <li class="col-sm-3">
                                ...
                                <ul>
                                    ...
                                    <li><a href="<?php echo base_url();?>assets/admin/bootstrap-tables.html">Bootstrap Tables</a></li>
