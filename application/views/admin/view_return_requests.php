            ...
            <div class="container-fluid">
                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <h4 class="page-title">Return/exchange Form Requests</h4>
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Return/exchange Form Requests</li>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="white-box">
                            ...
                            <h3 class="box-title m-b-0">Return/exchange Form Requests</h3>
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $this->db->query('select product_title from products where product_id = '.$val->productcode)->row()->product_title;?></td>
                                            <td><?php echo ($val->status == 0)?'Not Entertained':'Entertained';?></td>
                                        </tr>
                                    <?php }?>
                                    </tbody>
                                </table>
