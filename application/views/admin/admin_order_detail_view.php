            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php endif; ?>
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Order Details</h3>
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?php echo base_url() ?>assets/images/products/<?php echo $order->product_photo ?>" style="width:45px; hight:10px"></td>
