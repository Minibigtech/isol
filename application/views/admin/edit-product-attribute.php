                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Edit Product Attribute</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-info">
                            <div class="panel-heading">Edit Product Attribute</div>
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form action="<?php echo base_url();?>admin/update-product-attribute" method="post" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="title" placeholder="Color" value="<?php echo $attribute->pa_title;?>" required>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="status" required>
                                                            ...
                                                            <option value="1" <?php echo $attribute->pa_status==1?'selected':'';?> >Active</option>
                                                            <option value="0" <?php echo $attribute->pa_status==0?'selected':'';?>>Deactive</option>
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="form-actions">
                                            <input type="hidden" class="form-control" name="id" value="<?php echo $attribute->pa_id;?>">
