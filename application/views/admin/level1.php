    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <?php if( $this->session->flashdata('l1') ):?>
                        <div class="alert alert-success alert-dismissable">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
                            <?php echo $this->session->flashdata('l1');?>
                        </div>
                        <?php endif; ?>
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table width="100%">
                                    <tr>
                                        <td colspan="5" align="right">
                                            <a href="<?php echo base_url();?>admin/add-level1" title="Add New"><i class="fa fa-plus"></i></a></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="5">
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php if( !empty($level1) ):?>
                                        <?php $count = 1;?>
                                        <?php foreach( $level1 as $value ):?>
                                        <tr>
                                            <td><?php echo $count;?></td>
                                            <td><?php echo $value->cl1_title;?></td>
                                            <td><?php echo $value->cl1_icon!=''?'<img src="'.base_url('assets/images/level1/').$value->cl1_icon.'" style="width:20px; hight:20px">':'<img src="'.base_url('assets/images/no-image.png').'" style="width:20px; hight:20px">';?></td>
                                            <td><?php echo $value->cl1_photo!=''?'<img src="'.base_url('assets/images/level1/').$value->cl1_photo.'" style="width:100px; hight:100px">':'<img src="'.base_url('assets/images/no-image.png').'" style="width:100px; hight:100px">';?></td>
                                            <td><?php echo $value->cl1_status==1?'Active':'Deactive';?></td>
                                            <td>
                                                <a href="<?php echo base_url();?>admin/edit-level1/<?php echo $value->cl1_id;?>"><i class="fa fa-pencil" title="Edit"></i></a>
                                                  | 
    ...
    $(document).on('click','[title="Delete"]',function(){
        if( confirm( 'Are You Sure' ) ){
            if( $(this).attr('id') != '' && $(this).attr('id') != 0 ){
                $.ajax({
                    url: '<?php echo base_url();?>admin_actions/delete_level1_category',
                    type: 'POST',
