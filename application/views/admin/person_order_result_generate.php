                            ...
                            <div class="table-responsive">
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php if($val->created_by != ''){?>
                                        <tr>
                                            <td><?php echo $this->db->query('select admin_firstname from administrator where admin_id='.$val->created_by)->row()->admin_firstname;?></td>
                                            <td><?php echo $val->number_product;?></td>
                                        </tr>
                                    <?php }}?>
                                    </tbody>
                                </table>
