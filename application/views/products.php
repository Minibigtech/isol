...
<form action="" id="filters">
    ...
    <input type="hidden" class="size" name="size" value="<?php echo $_GET['size']; ?>">
    ...
    <input type="hidden" class="color" name="color" value="<?php echo $_GET['color']; ?>">
    ...
    <input type="hidden" class="gender" name="gender" value="<?php echo $_GET['gender']; ?>">
...
<script>
    ...
    $('input[type="checkbox"]').click(function(){
        ...
        $('#filters').append('<input class="'+name+'" type="hidden" name="'+name+'" value="'+b+'">');
    ...
    */
    ...
    $( ".price-slider" ).slider({
        ...
        stop: function(event, ui) {
            ...
            $('#filters').append('<input type="hidden" name="price" value="'+ui.values[0]+'-'+ui.values[1]+'">');
    ...
    $( ".price-value" ).text( "Rs. " + $( ".price-slider" ).slider( "values", 0 ) +

    " - Rs. " + $(".price-slider" ).slider( "values", 1 ));
